...
func (*HiRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6178f8ed730808e3, []int{0}
}
...
func (m *HiRequest) GetTracedata() map[string]string {
	if m != nil {
		return m.Tracedata
	}
	return nil
...
func (*HiResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6178f8ed730808e3, []int{1}
}
...
func (m *HiResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
func (m *HiResponse) GetTracedata() map[string]string {
	if m != nil {
		return m.Tracedata
	}
	return nil
...
func init() {
	proto.RegisterType((*HiRequest)(nil), "echo.HiRequest")
	proto.RegisterMapType((map[string]string)(nil), "echo.HiRequest.TracedataEntry")
	proto.RegisterType((*HiResponse)(nil), "echo.HiResponse")
	proto.RegisterMapType((map[string]string)(nil), "echo.HiResponse.TracedataEntry")
}

func init() { proto.RegisterFile("hw3/echo/echo.proto", fileDescriptor_6178f8ed730808e3) }

var fileDescriptor_6178f8ed730808e3 = []byte{
	// 238 bytes of a gzipped FileDescriptorProto
	,
}
